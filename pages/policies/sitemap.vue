      ...
      <div class="container mx-auto px-6 max-w-4xl">
        ...
        <div class="max-w-2xl mx-auto">
          <ul class="space-y-8">
            ...
            <li class="border-b border-apple-gray-100 pb-8">
              <h2 class="text-2xl font-semibold text-apple-gray-800 mb-4">Blog</h2>
              <ul class="space-y-3 text-apple-gray-600">
                <li>
                  <NuxtLink to="/blog" class="text-apple-blue hover:underline inline-flex items-center">
                    <span class="mr-2">Blog Home</span>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                  </NuxtLink>
                  <p class="text-sm text-apple-gray-500 mt-1">Thoughts, tutorials, and insights on web development, design, and technology</p>
                </li>
              </ul>
            </li>
